  ...
  update() {
    ...
    if (this.gameState === this.GAME_STATE.LOADING) {
      ...
      this.graphics.drawText('WEBCRAFT 2',
        this.GAME.WIDTH / 2 - 152, this.GAME.HEIGHT / 2 - 18, '32pt courier', '#22ff22');
      ...
      this.graphics.drawText(`[${this.genStr}] ${this.genPercent}%`,
        this.GAME.WIDTH / 2 - 162, this.GAME.HEIGHT / 2 + 80, '18pt courier', '#fff');
      ...
      this.graphics.drawText('Click to start',
        this.GAME.WIDTH / 2 - 112, this.GAME.HEIGHT / 2 + 20, '16pt courier', '#fff');
      this.graphics.drawText('Instructions:',
        this.GAME.WIDTH / 2 - 117, this.GAME.HEIGHT / 2 + 80, '18pt courier', '#fff');
      this.graphics.drawText('WASDEQ to move',
        this.GAME.WIDTH / 2 - 126, this.GAME.HEIGHT / 2 + 115, '18pt courier', 'A0A0A0');
      this.graphics.drawText('Arrows to pan',
        this.GAME.WIDTH / 2 - 117, this.GAME.HEIGHT / 2 + 140, '18pt courier', 'A0A0A0');
      this.graphics.drawText('PO for music',
        this.GAME.WIDTH / 2 - 108, this.GAME.HEIGHT / 2 + 165, '18pt courier', 'A0A0A0');
      this.worldTime = this.cycleTime / 4;
    } else if (this.gameState === this.GAME_STATE.PAUSED) {
      this.graphics.clear();

      this.graphics.drawText('PAUSED',
        this.GAME.WIDTH / 2 - 54, this.GAME.HEIGHT / 2 - 9, '18pt courier', '#fff');
    ...
    if (this.debug) {
      ...
      this.graphics.drawText(this.readableTime(),
        this.GAME.WIDTH - 60, 20, '10pt courier', '#A0A0A0');
        // Draw fps in bottom left corner
      this.graphics.drawText(`fps : ${(1 / dt).toFixed(3)}`,
        8, this.GAME.HEIGHT - 10, '18pt courier', '#A0A0A0');
        // Draw dt in bottom right corner
      this.graphics.drawText(`dt : ${dt.toFixed(3)}`,
        this.GAME.WIDTH - 150, this.GAME.HEIGHT - 10, '18pt courier', '#A0A0A0');
    }
